...
namespace leave_management.Controllers
{
    ...
    public class LeaveAllocationController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var mappedLeaveTypes = _mapper.Map<List<LeaveType>, List<DetailsLeaveTypeVM>>(leaveType);
        ...
        public ActionResult Details(string id)
        {
            ...
            var allocations = _mapper.Map<List<LeaveAllocationVM>>(_leaveAllocationRepo.GetLeaveAllocationsByEmploee(id));
