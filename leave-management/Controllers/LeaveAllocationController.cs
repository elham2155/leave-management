...
namespace leave_management.Controllers
{
    ...
    public class LeaveAllocationController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var mappedLeaveTypes = _mapper.Map<List<LeaveType>, List<DetailsLeaveTypeVM>>(leaveType.ToList());
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            var allocations = _mapper.Map<List<LeaveAllocationVM>>(await _leaveAllocationRepo.GetLeaveAllocationsByEmploee(id));
